enqueiry<?php include('include/header.php') ?>
<?php include('include/top.php') ?>
<?php include('include/left.php') ?>
<?php 
  $query=mysqli_query($connect,"SELECT * FROM enqueiry  ORDER BY id desc ");
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">General 
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> General Enquiry</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script>
  ...
  window.onload = function() {
    document.getElementById("generalenqueiry").className = "nav-link active";
