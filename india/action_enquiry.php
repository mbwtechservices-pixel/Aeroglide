...
<?php
    if(isset($_GET['submit'])){
                ...
                <div class="container" style="margin-top: 2em;border: 2px solid #ddd;">
                    <div style="padding: 2em;">
                        <table style="border-collapse:collapse;width:100%;border-top:1px solid #dddddd;border-left:1px solid #dddddd;margin-bottom:20px">
                            <tr>
                                <td style="font-size:12px;border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px"><img src="https://aeroglide.in/india/assets/images/logo.png" alt="AeroGlide logo"></td>
        ...
        // More headers
        $headers .= 'From: <enquiry@aeroglide.in>' . "\r\n";
        $headers .= 'Cc: aeroglide.ad@gmail.com' . "\r\n";
        $respons=mail($to,$subject,$body,$headers);
        $result=mysqli_query($connect,"INSERT INTO enqueiry(name,email,phone,msg,created_at,status)VALUES('$name','$email','$phone','$msg','$created_at','1')");
        /*print_r($result);exit;*/
        if($result){
